...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> Items Of <strong class="text-danger">{{ $auction->title }}</strong> Auction</h1>
    
    <a href="{{ route('addItemFromAuction', ['id' => Crypt::encrypt($auction->id)]) }}" class="btn-success btn btn-sm shadow-lg border-0"> Add New Record</a>
...
let ac_parent_id='{{ $auction->id }}';
$('#dataTableAuction').DataTable({
processing: true,
serverSide: true,
responsive: true,
ajax:{
url: "{{ route('get_specific_Auctions_item_ajax') }}",
data:{from_date:from_date, to_date:to_date,ac_parent_id:ac_parent_id,status:status,typep:typep}
},
columns:[
{
data: 'featured_img',
